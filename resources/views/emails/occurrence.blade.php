        ...
        <tr>
            <td align="center" style="padding: 20px 0;">
                <table width="600px" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-collapse: collapse; border: 1px solid #cccccc;">
                    <!-- Header -->
                    <tr>
                        <td style="padding: 20px; background-color: #3e84b5; color: white; text-align: center; font-size: 16px;">
                            <p>agenciaprimeweb.com.br | Tel: 83991263636</p>
                        </td>
                    </tr>
                    <!-- Logo and introduction -->
                    <tr>
                        <td style="padding: 20px; text-align: center;">
                            <img src="{{ asset('images/logo.jpeg') }}" alt="PrimeWeb Logo" style="width: 120px; height: auto;">
                            <p style="margin-top: 20px;">Prezado(a) Maria, sdsvsdvsd</p>
                        </td>
                    </tr>
                    <!-- Meeting details -->
                    <tr>
                        <td style="padding: 20px; text-align: center; border-top: 2px dashed #ccc;">
                            <p>Segue link para reunião conforme combinado para data de 08/09/2024 10:00</p>
                            <a href="meeting_link" style="display: inline-block; margin: 20px 0; padding: 10px 25px; background-color: #007BFF; color: white; text-decoration: none; border-radius: 5px;">Link reunião</a>
